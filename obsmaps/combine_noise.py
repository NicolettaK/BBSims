...
def compute_noise_factors(sensitivity_mode, one_over_f):
    ...
    **Returns**
    ...
    f_knee_pol = np.array([f_knee_pol_SA_27, f_knee_pol_SA_39, f_knee_pol_SA_93, f_knee_pol_SA_145, f_knee_pol_SA_225, f_knee_pol_SA_280])
    ...
    for nch in range(len(freqs)):
        ...
        wn_factor = wn_level_target/wn_levels_orig
        if one_over_f:
